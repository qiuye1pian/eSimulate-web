...
export const windPowerDefinition: ModelDefinition<WindPowerFormValues> = {
  ...
  fields: [
    { key: 'ratedPower', recordKey: 'p_r', label: '额定功率', unit: 'kW', min: 0, max: 5000 },
    { key: 'cutInSpeed', recordKey: 'v_in', label: '切入风速', unit: 'm/s', min: 0, max: 5000 },
    { key: 'ratedSpeed', recordKey: 'v_n', label: '额定风速', unit: 'm/s', min: 0, max: 5000 },
    { key: 'cutOutSpeed', recordKey: 'v_out', label: '切出风速', unit: 'm/s', min: 0, max: 5000 },
    {
