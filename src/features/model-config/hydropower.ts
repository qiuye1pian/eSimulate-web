...
export const hydropowerDefinition: ModelDefinition<HydropowerFormValues> = {
  ...
  fields: [
    ...
    { key: 'turbineEfficiency', recordKey: 'eta1', label: '水轮机效率', min: 0, max: 1, defaultValue: 0 },
    { key: 'generatorEfficiency', recordKey: 'eta2', label: '发电机效率', min: 0, max: 1, defaultValue: 0 },
    { key: 'transmissionEfficiency', recordKey: 'eta3', label: '机组传动效率', min: 0, max: 1, defaultValue: 0 },
    { key: 'head', recordKey: 'head', label: '水头', unit: 'm', readOnly: true },
    { key: 'upstreamElevation', recordKey: 'z1', label: '上游位能 Z1', unit: 'm', min: 1, max: 1000 },
    { key: 'downstreamElevation', recordKey: 'z2', label: '下游位能 Z2', unit: 'm', min: 1, max: 1000 },
    { key: 'upstreamVelocity', recordKey: 'v1', label: '上游平均流速 v1', unit: 'm³/s', min: 0, max: 1000 },
    { key: 'downstreamVelocity', recordKey: 'v2', label: '下游平均流速 v2', unit: 'm³/s', min: 0, max: 1000 },
    { key: 'upstreamDensity', recordKey: 'p1', label: '上游水密度 p1', unit: 'kg/m³', min: 900, max: 1100, defaultValue: 1000 },
